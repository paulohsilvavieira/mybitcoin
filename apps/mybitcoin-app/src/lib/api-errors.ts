...
const MESSAGE_BY_CODE: Record<string, string> = {
  ...
  TOO_MANY_LOGIN_ATTEMPTS: 'Muitas tentativas de login. Tente novamente em alguns minutos.',
  // Desvio consciente em relação ao front: lá, um erro de rede cai no `default`
  // do switch e exibe a mensagem crua do axios ("Network Error"). O ADR 0001
  // (Estados da UI / Edge Cases) especifica texto em pt-BR para offline, que
  // pesa muito mais em mobile do que na web.
